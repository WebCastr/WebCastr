        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    guid = table.Column<Guid>(type: "GUID", nullable: false),
                    name = table.Column<string>(type: "VARCHAR(100)", maxLength: 100, nullable: false),
                    short_name = table.Column<string>(type: "VARCHAR(100)", maxLength: 100, nullable: false),
                    description = table.Column<string>(type: "VARCHAR(255)", maxLength: 255, nullable: true),
                    enabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    url = table.Column<string>(type: "VARCHAR(250)", maxLength: 250, nullable: false),
                    timezone = table.Column<string>(type: "VARCHAR(250)", maxLength: 250, nullable: false),
                    audio_processing_method = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    name = table.Column<string>(type: "VARCHAR(100)", maxLength: 100, nullable: false),
                    url = table.Column<string>(type: "VARCHAR(255)", maxLength: 250, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_mount_point", x => x.id);
                    table.ForeignKey(
